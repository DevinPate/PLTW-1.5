...
# Controller updates the view by pulling data from model
    ...
    canvas.itemconfig(circle_item ,outline='#000000', fill='#' + \
                           hexstring(red_intvar) + \
                           hexstring(green_intvar) + '00')
...
canvas.grid(row=2, rowspan=2, column=2)


circle_item = canvas.create_oval(0, 0, 300, 300,
